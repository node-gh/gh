...
pullRequestPromptValues = function() {
    return [
        {
            name: 'submitPullRequest',
            message: 'Would you like to submit a pull request to remote origin branch? [Y/n]',
            empty: true
        }];
}
...
if (typeof exports != 'undefined' ) {
    ...
    exports.pullRequestPromptValues = pullRequestPromptValues;
}