...
Help.prototype.run = function() {
    ...
    filteredCmd = (options) ? options.argv.remain[1] : false;

    if (!filteredCmd && options && options.argv.remain[0] !== 'help') {
        filteredCmd = options.argv.remain[0];
    }
    ...
    cmdList.forEach(function(dir) {
        ...
        if (!filteredCmd || filteredCmd === alias || filteredCmd === name) {
            cmdOutput.push({
                alias: alias,
