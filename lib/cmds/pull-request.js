    ...
    if (options.list) {
        ...
        if (options.all) {
            if(options.org) {
                ...
                if(options.me) {
                    format = '{{prefix}} [info] Listing all {{options.state}} pull requests for {{greenBright options.org}} sent by {{greenBright options.loggedUser }}';
                } else {
                    format = '{{prefix}} [info] Listing all {{options.state}} pull requests for {{greenBright options.user}}';
                }
