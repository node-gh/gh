...
PullRequest.prototype.close = function(opt_callback) {
    ...
    operations = [
        function(callback) {
            instance.getPullRequest(function(err, data) {
                if (!err) {
                    pull = data;
                }
                callback(err);
...
PullRequest.prototype.getPullRequest = function(opt_callback) {
    var instance = this,
        options = instance.options,
        payload;
...
PullRequest.prototype.getPullsTemplateJson_ = function(pulls, opt_callback) {
    ...
    opt_callback && opt_callback(err, json);
};
...
PullRequest.prototype.open = function(opt_callback) {
    ...
    instance.getPullRequest(function(err, pull) {
        instance.updatePullRequest(
...
PullRequest.prototype.updatePullRequest = function(title, opt_body, state, opt_callback) {
    var instance = this,
        options = instance.options,
        payload;
