    ...
    operations = [
        function(callback) {
            instance.getPullRequest(
                options.user, options.repo, options.pull, function(err, data) {
                    if (!err) {
                        pull = data;
                    }
                    callback(err);
        ...
        function(callback) {
            instance.updatePullRequest(
                options.repo, options.pull, pull.title, pull.body,
...
PullRequest.prototype.fetch = function(opt_type, opt_callback) {
    ...
    async.series(operations, function(err) {
        ...
        logWithPullNumber(options.pull, 'fetch into branch ' + pullBranch);
    });
};
...
PullRequest.prototype.forward = function() {
    ...
    operations = [
        ...
        function(callback) {
            headBranch = instance.getBranchNameFromPullNumber_(options.pull);
            instance.submit(
                options.fwd, instance.currentRepository, headBranch,
                options.branch, headBranch, callback);
        },
        function(callback) {
...
PullRequest.prototype.merge = function(opt_callback) {
    ...
    operations = [
        ...
        function(callback) {
            ...
            logWithPullNumber(options.pull, (options.rebase ? 'rebasing' : 'merging') + ' into ' + options.branch);
        },
        function(callback) {
            instance.close(callback);
        }
    ...
    async.series(operations, function(err) {
        if (err) {
            logger.error('unable to merge pull request ' + options.pull);
        }
...
PullRequest.prototype.message = function() {
    ...
    base.github.issues.createComment(payload, function(err) {
        if (err) {
            logger.error('unable to message');
        }
