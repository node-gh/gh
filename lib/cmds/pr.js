    ...
    instance.getPullRequest_(base.getUser(), repository, number, function(err, pull) {
        ...
        git.exec(
            ...
            function(err) {
                ...
                if (fetchType === PullRequest.FETCH_TYPE_REBASE) {
                ...
                else if (fetchType === PullRequest.FETCH_TYPE_MERGE) {
...
PullRequest.prototype.merge = function(number, pullBranch, branch, opt_rebase) {
    ...
    operations = [
        function(callback) {
            instance.checkout_(branch, null, function(err, data) {
                console.log(data);
                callback(err);
            });
        },
...
PullRequest.prototype.submit = function(
    toUser, repository, headBranch, toBranch, title) {
