...
PullRequest.prototype.run = function(options, opt_def_repo, opt_def_branch) {
    var instance = this,
        branch,
        fetchType,
        repository;
    ...
    branch = options.branch || opt_def_branch;
    repository = opt_def_repo || PullRequest.DEFAULT_BRANCH_;
