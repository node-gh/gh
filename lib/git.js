...
exports.getGlobalConfigValue = function(key, opt_callback) {
    exports.exec('config', ['--global','--get', key], function(err, data) {
        if (opt_callback) opt_callback(err, data.trim());
    });
};
...
exports.mergeBranchWithCommitObject = function(branchName,opt_callback) {
    var args = [branchName];
    exports.exec('merge', args, opt_callback);
};
...
exports.init = function(opt_callback) {
    exports.exec('init', opt_callback);
};

exports.addRemote = function(remoteType,repoName,opt_callback) {
    var args = ['add',remoteType,repoName];
    exports.exec('remote', args, opt_callback);
};

exports.fetch = function(opt_callback) {
    exports.exec('fetch', opt_callback);
};

exports.checkoutBranch = function(branchName,opt_callback) {
    exports.exec('checkout', [branchName], opt_callback);
};