...
exports.checkout = function(branch, opt_newBranch, opt_callback) {
    ...
    exports.spawnGit('checkout', args, function(err, data) {
        opt_callback && opt_callback(err, data);
    });
};

exports.clone = function(url, folder) {
    var args = ['clone', url, folder];

    return child_process.spawnSync(git_command,
...
exports.deleteCurrentBranch = function(branch) {
...
exports.spawnGit = function(cmd, args, opt_callback) {
    var git;
...
exports.merge = function(branch, rebase, abort, opt_callback) {
    ...
    exports.spawnGit(type, [branch], function(err, data) {
        if (err) {
            console.log(data);

            if (abort) {
                exports.spawnGit(type, ['--abort'], function() {
